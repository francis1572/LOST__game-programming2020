...
public class boss_hp_controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //bool fgs_chgTerrain = flowchart.GetBooleanVariable("change");
        ...
        if (finalCountDown <= 0)
        {
            ...
            GetComponent<boss_hp_controller>().enabled = false;
    ...
    IEnumerator attack70()
    {
        ...
        butterflyInst.GetComponent<boss_butterfly>().isActive = false;
        yield return null;
    }
